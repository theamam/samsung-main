...
!(function () {
  ...
  function H(e) {
    ...
    if (!a.isMoved) {
      if (
        (y && x && s.loopFix({ direction: s.swipeDirection }),
    ...
    function (e) {
      ...
      function c(e) {
        ...
        if (t.params.loop) {
          ...
          if (s > t.slides.length - t.loopedSlides) r(s > a ? "next" : "prev");
      ...
      l("init", () => {
        ...
        (r.grid = {
          ...
          updateSlide: (e, a, n, l) => {
            ...
            (a.row = f),
              (a.column = h),
              (a.style[l("margin-top")] = 0 !== f ? p && `${p}px` : "");
          },
