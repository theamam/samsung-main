...
import {
  ...
  u as updateSwiper,
  c as attrToProp,
} from "./shared/update-swiper.min.mjs";
import { g as getParams } from "./shared/get-element-params.min.mjs";
import { S as Swiper } from "./shared/swiper-core.min.mjs";
const SwiperCSS =
...
const ClassToExtend =
  ...
  addStyle = (e, i) => {
    if ("undefined" != typeof CSSStyleSheet && e.adoptedStyleSheets) {
      ...
      t.replaceSync(i), (e.adoptedStyleSheets = [t]);
    } else {
      const t = document.createElement("style");
      (t.rel = "stylesheet"), (t.textContent = i), e.appendChild(t);
    }
  };
class SwiperContainer extends ClassToExtend {
  ...
  calcSlideSlots() {
    const e = this.slideSlots || 0,
      i = [...this.querySelectorAll("[slot^=slide-]")].map((e) =>
    ...
    if (((this.slideSlots = i.length ? Math.max(...i) + 1 : 0), this.rendered))
      if (this.slideSlots > e)
        for (let i = e; i < this.slideSlots; i += 1) {
          ...
          e.setAttribute("part", `slide slide-${i + 1}`);
          const t = document.createElement("slot");
          t.setAttribute("name", `slide-${i + 1}`),
            e.appendChild(t),
  ...
  render() {
    ...
    this.slideSlots > 0 && (e = e.replace(/::slotted\(([a-z-0-9.]*)\)/g, "$1")),
      e.length && addStyle(this.shadowRoot, e),
      this.cssLinks().forEach((e) => {
        if (this.shadowRoot.querySelector(`link[href="${e}"]`)) return;
        const i = document.createElement("link");
        (i.rel = "stylesheet"), (i.href = e), this.shadowRoot.appendChild(i);
      });
  ...
  initialize() {
    ...
    this.initialized = !0;
    const { params: i, passedParams: t } = getParams(this);
    (this.swiperParams = i),
      (this.passedParams = t),
      ...
      (this.swiper = new Swiper(this.shadowRoot.querySelector(".swiper"), {
        ...
        onAny: function (t) {
          "observerUpdate" === t && e.calcSlideSlots();
          const s = i.eventsPrefix
            ? `${i.eventsPrefix}${t.toLowerCase()}`
            : t.toLowerCase();
          for (
  ...
  updateSwiperOnPropChange(e, i) {
    const { params: t, passedParams: s } = getParams(this, e, i);
    (this.passedParams = s),
      (this.swiperParams = t),
      updateSwiper({
        swiper: this.swiper,
        passedParams: this.passedParams,
        changedParams: [attrToProp(e)],
        ...("navigation" === e && s[e]
...
paramsList.forEach((e) => {
  "init" !== e &&
    ((e = e.replace("_", "")),
    Object.defineProperty(SwiperContainer.prototype, e, {
      configurable: !0,
      get() {
      ...
      set(i) {
        this.passedParams || (this.passedParams = {}),
          (this.passedParams[e] = i),
          this.initialized && this.updateSwiperOnPropChange(e, i);
      },
    }));
});
...
//# sourceMappingURL=swiper-element-bundle.min.mjs.map
